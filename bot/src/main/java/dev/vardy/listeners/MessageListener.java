...
import dev.vardy.utils.objects.ExpiringCache;
import dev.vardy.utils.objects.GuildedCache;
import dev.vardy.utils.objects.MinimalMessage;
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        for(String key : tags.getKeys()) {
            try {
                ...
                LoyalBot.INSTANCE.getLogger().info("Tag \"{}\" failed in guild {}: {}", key, event.getGuild().getId(), exception.getMessage());
            }
        }
