...
import dev.vardy.utils.objects.Comparator;
...
public abstract class Command {
    ...
    public void preprocess(CommandContext context) {
        ...
        LoyalBot.INSTANCE.getLogger().info("{} executed the command {} in {}", context.getMember().getUser().getId(), name, context.getGuild().getId());
